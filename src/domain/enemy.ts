...
export class Enemy extends LevelObject {
    ...
    playNothingFoundSound() {
        ...
        const audio = new Audio(`${import.meta.env.BASE_URL}/assets/sounds/robot_nothing.wav`);
        audio.volume = 0.3;
    ...
    playTargetAcquiredSound() {
        ...
        const audio = new Audio(`${import.meta.env.BASE_URL}/assets/sounds/robot_target_acquired.wav`);
        audio.volume = 0.3;
        audio.play().catch(error => {
            console.error('Error playing sound:', error);
        });
    ...
    playTargetNeutralizedSound() {
        ...
        const audio = new Audio(`${import.meta.env.BASE_URL}/assets/sounds/robot_target_neutralized.wav`);
        audio.volume = 0.3;
        audio.play().catch(error => {
            console.error('Error playing sound:', error);
        });
